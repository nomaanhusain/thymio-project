...
def main(use_sim=False, ip='localhost', port=2001):
    ...
    try:
        ...
        while True:
            ...
            if robot["button.forward"] == 1: # vorgegeben 
                state = "AR"
            elif robot["button.backward"] == 1:
                state = "INDECISIVE"
            ...
            if state == "AR":
                ...
                if robot['prox.horizontal'][5] > 100 or robot['prox.horizontal'][6] > 100:
                ...
                if robot['prox.horizontal'][2] > 300:
                    robot['motor.left.target'] = -200
                    robot['motor.right.target'] = -200
                else:
                    robot['motor.left.target'] = 200
